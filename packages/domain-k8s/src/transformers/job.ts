...
/** Normalizes Job conditions so the observability board can tell whether batches completed, failed, or are retrying. */
...
/** Produces the JobSummary rows powering the batch workload sections on the dashboard. */
...
/**
 * Builds the JobDetail payload so the board can surface selectors, retry policies, and condition history.
 */
