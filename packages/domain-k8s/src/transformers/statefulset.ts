...
/** Converts the StatefulSet updateStrategy into the structure rendered on the board. */
...
/** Maps StatefulSet volumeClaimTemplates into the VolumeClaimTemplate type for display. */
...
/** Normalizes StatefulSet conditions for health badges in the dashboard. */
const toConditions = (
...
/** Builds the StatefulSetSummary used throughout observability namespace views. */
...
/**
 * Produces the StatefulSetDetail payload so the board can expose selectors, PVC templates, and strategy information.
 */
