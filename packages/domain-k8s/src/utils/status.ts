...
/**
 * Synthesizes a concise pod status string so the observability board can display a single badge derived from Kubernetes pod states.
 */
...
/**
 * Calculates a Service-level readiness indicator so the board can depict whether all targeted ports are healthy per Kubernetes status.
 */
