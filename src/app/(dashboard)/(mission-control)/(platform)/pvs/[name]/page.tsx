...
import { getPVDetail } from '@domain-k8s/services/pv.service'
...
export default async function Page({ params }: PageProps) {
  ...
  let detail: Awaited<ReturnType<typeof getPVDetail>> | null = null
  let error: ReturnType<typeof parseK8sError> | null = null

  try {
    detail = await getPVDetail(name, {
      includeRaw: true,
      includeYaml: true,
    })
  } catch (err) {
